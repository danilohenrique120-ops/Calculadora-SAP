...
export const VarianceThresholdsManager: React.FC<VarianceThresholdsManagerProps> = ({
  ...
  const simVariancePercent = simStandardMin > 0 ? ((simRealMin - simStandardMin) / simStandardMin) * 100 : 0;
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 pt-1">
          ...
          >
            ...
            <p className="text-[11px] text-slate-400">
              Calcula o desvio em relação ao padrão: <code className="text-slate-300">(Real - Standard) ÷ Standard</code> (ex: -10m = -7.9%, +156m = +5.0%).
            </p>
          </button>
