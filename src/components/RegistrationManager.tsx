        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          {onLockAdmin && (
            <button
              type="button"
              onClick={onLockAdmin}
              className="flex items-center space-x-1.5 px-3 py-1.5 bg-rose-500/15 hover:bg-rose-500/25 text-rose-300 hover:text-white border border-rose-500/30 rounded-xl text-xs font-semibold transition cursor-pointer shadow-sm"
